...
type ChainReader interface {
	...
	// // BLS-Upgrade: GetLastVote retrieves the most recent vote history from the database by number.
...
type Engine interface {
	...
	// BLS-Upgrade: Protocol returns the protocol for this consensus
	Protocol() Protocol
	// /BLS-Upgrade
}
