...
func testAnnounce(t *testing.T) {
	...
	var decodedPP *hotstuff.Announce
	err = decodedMsg.Decode(&decodedPP)
	if err != nil {
		t.Errorf("error mismatch: have %v, want nil", err)
	}

	// if block is encoded/decoded by rlp, we cannot to compare interface data type using reflect.DeepEqual. (like hotstuff.Proposal)
...
func testSubject(t *testing.T) {
	...
	var decodedSub *hotstuff.Subject
