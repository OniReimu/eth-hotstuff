...
// BLS-Upgrade: protocolName is the official short name of the protocol used during capability negotiation.
...
var errorToString = map[int]string{
	...
	// // BLS-Upgrade
	// ErrPreReq:  "Unknown speaker as local node is the current speaker",
	// ErrPreResp: "Fail to recognize PrepareResponseMsg",
	// ErrChangeV: "Fail to recognize ChangeViewMsg",
